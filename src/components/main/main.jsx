        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{moviePromoName}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">{moviePromoGenre}</span>
                <span className="movie-card__year">{moviePromoReleased}</span>
              </p>
